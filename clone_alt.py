    ...
    def edit_file(file_path):
        ...
        with open(file_path, "r") as file, open(temp_file_path, "w") as temp_file:
            ...
            for line in file:
                ...
                if new_line != line:
                    print("Replaced 'value=\"v1\",' with value=\"v2\",'")
                    changes_made = True
                line = new_line

                new_line = line.replace("maximum=40,", "maximum=80,")
                if new_line != line:
                    print("Replaced 'maximum=40,' with 'maximum=80,'")
                    changes_made = True
                line = new_line

                new_line = line.replace("maximum=50,", "maximum=1000,")
                if new_line != line:
                    print("Replaced 'maximum=50,' with 'maximum=1000,'")
                    changes_made = True
                line = new_line

                new_line = line.replace('value="pretrained/f0G40k.pth",','value="pretrained_v2/f0G48k.pth",')
                if new_line != line:
                    print("Replaced 'value=\"pretrained/f0G40k.pth\"' with 'value=\"pretrained_v2/f0G48k.pth\"'")
                    changes_made = True
                line = new_line

                new_line = line.replace('value="pretrained/f0D40k.pth",','value="pretrained_v2/f0D48k.pth",')
                if new_line != line:
                    print("Replaced 'value=\"pretrained/f0D40k.pth\"' with 'value=\"pretrained_v2/f0D48k.pth\"'")
                    changes_made = True
                line = new_line
